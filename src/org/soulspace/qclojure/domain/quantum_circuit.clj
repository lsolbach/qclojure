...
(defn compose-circuits
  ...
  Both circuits must operate on the same number of qubits.
  ...
  Throws:
  Exception if circuits have different numbers of qubits
  ...
  {:pre [(s/valid? ::quantum-circuit circuit1)
         ...
         (= (:num-qubits circuit1) (:num-qubits circuit2))]}
  (-> circuit1
      (update :gates #(into % (:gates circuit2)))
      (assoc :name (str (get circuit1 :name "Circuit1") " + " (get circuit2 :name "Circuit2")))))
